<x-app-layout>
    ...
    <div class="py-12">
        ...
        <form method='POST' action="{{ route('statistics.update', $statistic) }}">
            @csrf
            @method('PUT')
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <input class="form-input rounded-md shadow-sm mt-1 block w-full" id="name" name="name" type="text" value="{{ $statistic->name }}">
                        </div>
                        <div class="col-span-6 sm:col-span-4">
                            <label class="block font-medium text-sm text-gray-700" for="city_id">
                                Id Ciudad
                            </label>
                            <input  class="form-input rounded-md shadow-sm mt-1 block w-full" id="city_id" name="city_id" type="text" value="{{ $statistic->city_id }}">
                        </div>
                        <div class="col-span-6 sm:col-span-4">
                            <label class="block font-medium text-sm text-gray-700" for="population">
                                Poblacion
                            </label>
                            <input  class="form-input rounded-md shadow-sm mt-1 block w-full" id="population" name="population" type="text" value="{{ $statistic->population }}">
                        </div>
                        <div class="col-span-6 sm:col-span-4">
